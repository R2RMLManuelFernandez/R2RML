...
public class MariadbDatabaseConnection extends DatabaseConnection {
	...
	public MariadbDatabaseConnection(Database database) throws SQLException {
	...
	public void setDatabaseURL() throws SQLException {
		...
		super.databaseURL = "jdbc:mariadb://" + database.getHost().getHostAddress() + ":" + database.getPort() + "/" + database.getDatabaseName();
